...
for fold in range(1,6):
    ...
    for i,data in enumerate(test_loader):
        ...
        plt.colorbar()
        savename2 = r'/home/hdd/yanguo/results_cv4/fold'+str(fold)+'/test_results/sim/'+'test_' + str(i)
    ...
    io.savemat(r'/home/hdd/yanguo/results_cv4/fold'+str(fold)+'/direct_recon_results/sim/recon_slowness_hat.mat',
               {'recon_slowness_hat':Y_test_hat})
    io.savemat(r'/home/hdd/yanguo/results_cv4/fold'+str(fold)+'/direct_recon_results/sim/recon_slowness_label.mat',
               {'recon_slowness_label':Y_test})
    io.savemat(r'/home/hdd/yanguo/results_cv4/fold'+str(fold)+'/direct_recon_results/sim/TTDMs.mat', {'TTDMs':X_test})

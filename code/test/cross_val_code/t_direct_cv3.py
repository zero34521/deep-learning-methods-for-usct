...
for fold in range(1,6):
    ...
    # folder_path = r'E:\code\remote_document\reconstruction_USCT\Results_saved\direct\2021.01.20.1\model_results/'
    ...
    folder_path = r'E:\code\remote_document\rescontruction_USCT\hdd_yanguo\Results_saved_cv\direct\2021.03.17.1'#本地模型路径
    save_path=folder_path+'/fold'+str(fold)+'/model_results/'
    model_name = 'direct' #option:direct\unet

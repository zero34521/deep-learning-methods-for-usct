...
for fold in range(1,6):
    ...
    save_path = r'E:\code\remote_document\rescontruction_USCT\hdd_yanguo\results_cv2/fold' + str(fold) + '/model_results/'
    ...
    for i, data in enumerate(test_loader):
        ...
        # plt.colorbar()
        # savename2 = r'/home/hdd/yanguo/results_cv2/fold' + str(fold) + '/test_results/sim/test_pre_' + str(i)
        # plt.savefig(savename2)
        # plt.close()
        # plt.figure()
        # plt.imshow(compare_result_test_direct, vmin=-2, vmax=2)
        # plt.colorbar()
        # savename2 = r'/home/hdd/yanguo/results_cv2/fold' + str(fold) + '/test_results/sim/test_direct_' + str(i)
        # plt.savefig(savename2)
        # plt.close()
        '''保存预测结果'''
    ...
    # io.savemat(r'/home/hdd/yanguo/results_cv2/fold' + str(fold) + '/PTTDMs_RECONs_hat_results/sim/TTDMs.mat', {'TTDMs': X_test})
    # io.savemat(r'/home/hdd/yanguo/results_cv2/fold' + str(fold) + '/PTTDMs_RECONs_hat_results/sim/recon_slowness_hat.mat',
    #            {'recon_slowness_hat': RECONs_hat})
    # io.savemat(r'/home/hdd/yanguo/results_cv2/fold' + str(fold) + '/PTTDMs_RECONs_hat_results/sim/PTTDMs_hat.mat',
    #            {'PTTDMs_hat': PTTDMs_hat})
    # io.savemat(r'/home/hdd/yanguo/results_cv2/fold' + str(fold) + '/PTTDMs_RECONs_hat_results/sim/PTTDMs.mat', {'PTTDMs': Y1_test})
    # io.savemat(r'/home/hdd/yanguo/results_cv2/fold' + str(fold) + '/PTTDMs_RECONs_hat_results/sim/recon_slowness_label.mat', {'recon_slowness_label': Y2_test})

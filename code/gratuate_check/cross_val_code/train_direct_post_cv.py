...
for fold in range(1,6):
    ...
    message = '-------------------------------------------------------------------------------------------------------'
    with open(r'/home/hdd/yanguo/results_cv1/fold'+str(fold)+'/loss_results/log.txt', 'a') as log_f:
       log_f.write('%s\n' % message)
       log_f.write('%s\n' % message_batch_size)
       log_f.write('%s\n' % device_message)
    #学习率初始值设定
    ...
    for epoch in range(1,300):
       ...
       if epoch % 2 == 0:
          ...
          plt.colorbar()
          savename1 = r'/home/hdd/yanguo/results_cv1/fold'+str(fold)+'/train_results/'+'train_direct_epoch' + str(epoch)
          plt.savefig(savename1)
          plt.close()
          plt.figure()
          plt.imshow(compare_result_train2,vmin=-1,vmax=1)
          plt.colorbar()
          savename2 = r'/home/hdd/yanguo/results_cv1/fold'+str(fold)+'/train_results/'+'train_post_epoch' + str(epoch)
       ...
       if epoch % 2 == 0:
          ...
          plt.colorbar()
          savename2 = r'/home/hdd/yanguo/results_cv1/fold'+str(fold)+'/train_results/'+'val_direct_epoch' + str(epoch)
          plt.savefig(savename2)
          plt.close()
          plt.figure()
          plt.imshow(compare_result_val2,vmin=-1,vmax=1)
          plt.colorbar()
          savename2 = r'/home/hdd/yanguo/results_cv1/fold'+str(fold)+'/train_results/'+'val_post_epoch' + str(epoch)
          plt.savefig(savename2)
          plt.close()
    ...
    with open(r'/home/hdd/yanguo/results_cv1/fold' + str(fold) + '/loss_results/log.txt', 'a') as log_f:
        log_f.write('%s\n' % message_update)
    '''保存学习率曲线数据'''
    np.save(r'/home/hdd/yanguo/results_cv1/fold'+str(fold)+'/loss_results/train_loss_post.npy', train_loss_post)
    np.save(r'/home/hdd/yanguo/results_cv1/fold'+str(fold)+'/loss_results/val_loss_save_post.npy',val_loss_save_post)
    np.save(r'/home/hdd/yanguo/results_cv1/fold'+str(fold)+'/loss_results/train_loss_direct.npy', train_loss_direct)
    np.save(r'/home/hdd/yanguo/results_cv1/fold'+str(fold)+'/loss_results/val_loss_save_direct.npy',val_loss_save_direct)
    #############最终模型的保存############
    '''-----------后处理模型保存-----------'''
    '''方式一'''
    # save_path=r'/home/hdd/yanguo/results_cv1/fold'+str(fold)+'/model_results/'
    ...
    pic_savename1 = '/home/hdd/yanguo/results_cv1/fold'+str(fold)+'/loss_results/train_val_loss_post.png'

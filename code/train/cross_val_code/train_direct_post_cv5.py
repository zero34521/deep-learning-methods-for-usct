...
for fold in range(1,6):
    ...
    # pre_model_dict_pretrained=post_net_pretrained.state_dict()#获取预训练权重
    # post_net.load_state_dict(pre_model_dict_pretrained)#预训练权重赋值
    ...
    for epoch in range(1,100):
       ...
       if epoch % 2 == 0:
          ...
          plt.colorbar()
          savename1 = r'/home/hdd/yanguo/results_cv5/fold'+str(fold)+'/train_results/'+'train_direct_epoch' + str(epoch)
          plt.savefig(savename1)
          plt.close()
          plt.figure()
          plt.imshow(compare_result_train2,vmin=-1,vmax=1)
          plt.colorbar()
          savename2 = r'/home/hdd/yanguo/results_cv5/fold'+str(fold)+'/train_results/'+'train_post_epoch' + str(epoch)
       ...
       if epoch % 2 == 0:
          ...
          plt.colorbar()
          savename2 = r'/home/hdd/yanguo/results_cv5/fold'+str(fold)+'/train_results/'+'val_post_epoch' + str(epoch)
          plt.savefig(savename2)
          plt.close()
    ...
    with open(r'/home/hdd/yanguo/results_cv5/fold' + str(fold) + '/loss_results/log.txt', 'a') as log_f:
        log_f.write('%s\n' % message_update)
    '''保存学习率曲线数据'''
    np.save(r'/home/hdd/yanguo/results_cv5/fold'+str(fold)+'/loss_results/train_loss_post.npy', train_loss_post)
    np.save(r'/home/hdd/yanguo/results_cv5/fold'+str(fold)+'/loss_results/val_loss_save_post.npy',val_loss_save_post)
    ...
    pic_savename1 = '/home/hdd/yanguo/results_cv5/fold'+str(fold)+'/loss_results/train_val_loss_post.png'
    ...
    pic_savename1 = '/home/hdd/yanguo/results_cv5/fold'+str(fold)+'/loss_results/train_val_loss_direct.png'
    plt.savefig(pic_savename1)
    plt.show()
    plt.close()

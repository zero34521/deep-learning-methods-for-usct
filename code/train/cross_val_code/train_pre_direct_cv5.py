...
for fold in range(5,6):
    ...
    #---初始化前处理权重---
    # save_path = r'/home/hdd/yanguo/results_cv5/fold'+str(fold)+'/results_cv5_saved/pre_direct/2020.10.16.1/model_results/'
    # save_path = r'/home/hdd/yanguo/results_cv5/fold'+str(fold)+'/results_cv5_saved/pre/2020.10.15.1/model_results/'
    ...
    with open(r'/home/hdd/yanguo/results_cv5/fold'+str(fold)+'/loss_results/log.txt', 'a') as log_f:
       log_f.write('%s\n' % message)
       log_f.write('%s\n' % device_message)
       log_f.write('%s\n' % message_batch_size)
    #学习率初始值设定
    train_loss_pre=[]#学习率保存
    train_loss_direct=[]#学习率保存
    val_loss_save_pre=[]
    ...
    for epoch in range(1,100):
       ...
       if epoch % 2 == 0:
          ...
          plt.colorbar()
          savename1 = r'/home/hdd/yanguo/results_cv5/fold'+str(fold)+'/train_results/'+'train_pre_epoch' + str(epoch)
          plt.savefig(savename1)
          plt.close()
          plt.figure()
          plt.imshow(compare_result_train2,vmin=-2,vmax=2)
          plt.colorbar()
          savename2 = r'/home/hdd/yanguo/results_cv5/fold'+str(fold)+'/train_results/'+'train_direct_epoch' + str(epoch)
       ...
       if epoch % 2 == 0:
          ...
          plt.colorbar()
          savename2 = r'/home/hdd/yanguo/results_cv5/fold'+str(fold)+'/train_results/'+'val_pre_epoch' + str(epoch)
          plt.savefig(savename2)
          plt.close()
          plt.figure()
          plt.imshow(compare_result_val_direct,vmin=-2,vmax=2)
          plt.colorbar()
          savename2 = r'/home/hdd/yanguo/results_cv5/fold'+str(fold)+'/train_results/'+'val_direct_epoch' + str(epoch)
          plt.savefig(savename2)
          plt.close()
    ...
    with open(r'/home/hdd/yanguo/results_cv5/fold' + str(fold) + '/loss_results/log.txt', 'a') as log_f:
        log_f.write('%s\n' % message_update)
    '''保存学习率曲线数据'''
    np.save(r'/home/hdd/yanguo/results_cv5/fold'+str(fold)+'/loss_results/train_loss_pre.npy', train_loss_pre)
    np.save(r'/home/hdd/yanguo/results_cv5/fold'+str(fold)+'/loss_results/val_loss_save_pre.npy',val_loss_save_pre)
    np.save(r'/home/hdd/yanguo/results_cv5/fold'+str(fold)+'/loss_results/train_loss_direct.npy', train_loss_direct)
    np.save(r'/home/hdd/yanguo/results_cv5/fold'+str(fold)+'/loss_results/val_loss_save_direct.npy',val_loss_save_direct)
    #############最终模型的保存############
    # '''-----------前处理模型保存-----------'''
    # '''方式一'''
    # # save_path=r'/home/hdd/yanguo/results_cv5/fold'+str(fold)+'/model_results/'
    ...
    pic_savename1 = '/home/hdd/yanguo/results_cv5/fold'+str(fold)+'/loss_results/train_val_loss_pre.png'
    ...
    pic_savename2 = '/home/hdd/yanguo/results_cv5/fold'+str(fold)+'/loss_results/train_val_loss_direct.png'
